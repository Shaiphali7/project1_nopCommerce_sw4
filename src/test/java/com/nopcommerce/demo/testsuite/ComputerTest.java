...
public class ComputerTest extends BaseTest {
    ...
    ComputerProductShoppingCart shoppingCart = new ComputerProductShoppingCart();
...
//        2.4 Click on "Add To Cart"
        computerPage.addToCartButtonAtDesktopPage();
//        2.5 Verify the Text "Build your own computer"
        String actualProductName = computerPage.buildYourComputerString();
        Assert.assertEquals(actualProductName, "Build your own computer", "Wrong product");
//        2.6 Select "2.2 GHz Intel Pentium Dual-Core E2200" using Select class
        computerPage.selectFromprocessorDroDown("2.2 GHz Intel Pentium Dual-Core E2200");
//        2.7.Select "8GB [+$60.00]" using Select class.
        computerPage.selectFromramDropDown("8GB [+$60.00]");
//        2.8 Select HDD radio "400 GB [+$100.00]"
        computerPage.clickOnhddCheckBox();
//        2.9 Select OS radio "Vista Premium [+$60.00]"
        computerPage.clickOnosCheckBox();
//        2.10 Check Two Check boxes "Microsoft Office [+$50.00]" and "Total Commander
//            [+$5.00]"
        computerPage.clickOnsoftwareCheckBox();
        Thread.sleep(2000);
//        2.11 Verify the price "$1,475.00"

        String totalPrice = computerPage.getTotalPrice();
        Assert.assertEquals(totalPrice, "$1,470.00", "Total price is not same");
//        2.12 Click on "ADD TO CARD" Button.
        computerPage.clickOnaddToCartProductButton();
//        2.13 Verify the Message "The product has been added to your shopping cart" on Top
//        green Bar
        String actualSuccessMessage = computerPage.getSuccessMessage();
...
//        2.17 Verify the Total"$2,950.00"
        ...
        Assert.assertEquals(cartTotalPrice, "$2,950.00");
